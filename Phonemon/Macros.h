...
#define INFO()  if (GEngine) GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, FString::Printf(TEXT("File : %s ; Line : %d ; Compiled : %s ;"), TEXT(__FILE__), __LINE__, *FString(__DATE__))); 
